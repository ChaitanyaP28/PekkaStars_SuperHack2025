""" Service 2.py: Simulate Critical Failure handling using AI agent """
...
if __name__ == "__main__":
    ...
    try:
        ...
        log(f"User entered a = {a}")
        
        b = input("Enter second number (b): ")
        log(f"User entered b = {b}")
        ...
        error(f"Division by zero error: {str(e)}")
    except ValueError as e:
        error(f"Invalid input error: {str(e)}")
